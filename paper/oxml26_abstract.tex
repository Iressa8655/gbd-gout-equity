...
%% Abstract
\begin{abstract}
Gout is clinically manageable with established urate-lowering therapy, yet
treatment gaps persist across health systems worldwide. Countries whose gout burden exceeds what their economic development
...
populations~\cite{phippsgreen2010}. A choropleth of M5 residuals confirms
that unexplained burden is geographically concentrated in these Anglophone
countries and the Caucasus (all code and figures available at
\url{https://github.com/Iressa8655/gbd-gout-equity}).

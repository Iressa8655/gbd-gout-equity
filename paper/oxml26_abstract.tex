...
R\textsuperscript{2}~=~0.504. Georgia carried the largest unexplained residual
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{../figures/fig4_dual_panel.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{../figures/fig6_shap.png}
